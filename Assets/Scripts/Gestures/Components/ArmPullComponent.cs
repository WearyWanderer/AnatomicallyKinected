...
{
	/// <summary>
	/// A gesture component which checks for a pulling motion on the left or right arm.
	/// </summary>
	public sealed class ArmPullComponent : SideComponent
	{
		/// <summary>
		...
		public ArmPullComponent (SkeletonWrapper kinect, Side side, float tolerance = 0.5f)
		{
			this.kinect    = kinect;
			this.side      = side;
		...
		/// <summary>
		/// Examines the velocity of the desired arm to see if it's making a pulling motion.
		/// </summary>
